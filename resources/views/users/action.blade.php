...
<a href="javascript:void(0)" data-toggle="tooltip" data-original-title="Log" class="log btn btn-sm btn-warning">
	<i class="mdi mdi-history menu-icon"></i>
</a>

<a href="javascript:void(0)" data-toggle="tooltip" data-original-title="Log" class="log btn btn-sm btn-info">
